          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-on-primary-fixed text-label-md font-semibold uppercase tracking-widest mb-1">
                ...
                <div className="flex flex-wrap items-center gap-4 text-inverse-on-surface/60 text-body-md">
                  ...
                  {avgRating && (
                    <span className="flex items-center gap-1">
                      <svg className="w-4 h-4 text-on-primary-fixed" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  {educator.hourlyRate && (
                    <span className="text-on-primary-fixed font-bold">{formatCurrency(educator.hourlyRate.toNumber())} / saat</span>
                  )}
                </div>
              </div>
              {role === "PARENT" ? (
